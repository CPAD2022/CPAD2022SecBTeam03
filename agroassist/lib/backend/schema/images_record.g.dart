...
class _$ImagesRecord extends ImagesRecord {
  ...
  _$ImagesRecord._({this.img, this.ffRef}) : super._();
  ...
  bool operator ==(Object other) {
    ...
    return other is ImagesRecord && img == other.img && ffRef == other.ffRef;
  }

  @override
  int get hashCode {
    return $jf($jc($jc(0, img.hashCode), ffRef.hashCode));
  }
...
class ImagesRecordBuilder
  ...
  _$ImagesRecord _build() {
    final _$result = _$v ?? new _$ImagesRecord._(img: img, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
