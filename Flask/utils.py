disease_dic = {
    ...
    "Apple___healthy":{
        "Crop": "Apple",
        "Disease": "Your plant looks healthy!",
        "Cause": ["No disease has been detected"],
        "Prevention": ["Good work!"]
    },
    "Blueberry___healthy":{
        "Crop": "Blueberry",
        "Disease": "Your plant looks healthy!",
    ...
    "Corn_(maize)___Northern_Leaf_Blight":{
        ...
        "Prevention": ["Management of NCLB can be achieved primarily by using hybrids with resistance, but because resistance may not be complete or may fail, it is advantageous to utilize an integrated approach with different cropping practices and fungicides.", "Scouting fields and monitoring local conditions is vital to control this disease."]
    },
    "Grape___Black_rot":{
        "Crop": "Grape",
        "Disease": "Black Rot",
        ...
        "Prevention": ["Space vines properly and choose a planting site where the vines will be exposed to full sun and good air circulation. Keep the vines off the ground and insure they are properly tied, limiting the amount of time the vines remain wet thus reducing infection.", "Keep the fruit planting and surrounding areas free of weeds and tall grass. This practice will promote lower relative humidity and rapid drying of vines and thereby limit fungal infection.", "Use protective fungicide sprays. Pesticides registered to protect the developing new growth include copper, captan, ferbam, mancozeb, maneb, triadimefon, and ziram. Important spraying times are as new shoots are 2 to 4 inches long, and again when they are 10 to 15 inches long, just before bloom, just after bloom, and when the fruit has set."]
    },
    ...
    "Grape___Esca_(Black_Measles)":{
        ...
        "Cause": ["1. Black Measles is caused by a complex of fungi that includes several species of Phaeoacremonium, primarily by P. aleophilum (currently known by the name of its sexual stage, Togninia minima), and by Phaeomoniella chlamydospora.", "The overwintering structures that produce spores (perithecia or pycnidia, depending on the pathogen) are embedded in diseased woody parts of vines. The overwintering structures that produce spores (perithecia or pycnidia, depending on the pathogen) are embedded in diseased woody parts of vines.", "During fall to spring rainfall, spores are released and wounds made by dormant pruning provide infection sites.", "Wounds may remain susceptible to infection for several weeks after pruning with susceptibility declining over time."],
        "Prevention": ["Post-infection practices (sanitation and vine surgery) for use in diseased, mature vineyards are not as effective and are far more costly than adopting preventative practices (delayed pruning, double pruning, and applications of pruning-wound protectants) in young vineyards.", "Sanitation and vine surgery may help maintain yields. In spring, look for dead spurs or for stunted shoots. Later in summer, when there is a reduced chance of rainfall, practice good sanitation by cutting off these cankered portions of the vine beyond the canker, to where wood appears healthy. Then remove diseased, woody debris from the vineyard and destroy it.", "The fungicides labeled as pruning-wound protectants, consider using alternative materials, such as a wound sealant with 5 percent boric acid in acrylic paint (Tech-Gro B-Lock), which is effective against Eutypa dieback and Esca, or an essential oil (Safecoat VitiSeal)."]
    },
    "Grape___Leaf_blight_(Isariopsis_Leaf_Spot)":{
        "Crop": "Grape",
        "Disease": "Leaf Blight",
        "Cause": ["Apple scab overwinters primarily in fallen leaves and in the soil. Disease development is favored by wet, cool weather that generally occurs in spring and early summer.", "Fungal spores are carried by wind, rain or splashing water from the ground to flowers, leaves or fruit. During damp or rainy periods, newly opening apple leaves are extremely susceptible to infection. The longer the leaves remain wet, the more severe the infection will be. Apple scab spreads rapidly between 55-75 degrees Fahrenheit."],
        "Prevention": ["Choose resistant varieties when possible.", "Rake under trees and destroy infected leaves to reduce the number of fungal spores available to start the disease cycle over again next spring"]
    },
    "Grape___healthy":{
        "Crop": "Grape",
        "Disease": "Your plant looks healthy!",
    ...
    "Orange___Haunglongbing_(Citrus_greening)":{
        ...
        "Prevention": ["In regions where disease incidence is low, the most common practices are avoiding the spread of infection by removal of symptomatic trees, protecting grove edges through intensive monitoring, use of pesticides, and biological control of the vector ACP.", "According to Singerman and Useche (2016), CHMAs coordinate insecticide application to control the ACP spreading across area-wide neighboring commercial citrus groves as part of a plan to address the HLB disease.", "In addition to foliar nutritional sprays, plant growth regulators were tested, unsuccessfully, to reduce HLB-associated fruit drop (Albrigo and Stover, 2015)."]
    },
    "Peach___Bacterial_spot":{
        ...
        "Prevention": ["The most effective management strategy is the use of pathogen-free certified seeds and disease-free transplants to prevent the introduction of the pathogen into greenhouses and field production areas. Inspect plants very carefully and reject infected transplants- including your own!", "In transplant production greenhouses, minimize overwatering and handling of seedlings when they are wet.", "Trays, benches, tools, and greenhouse structures should be washed and sanitized between seedlings crops.", "Do not spray, tie, harvest, or handle wet plants as that can spread the disease."]
    },
    ...
    "Squash___Powdery_mildew":{
        ...
        "Prevention": ["Apply fertilizer based on soil test results. Avoid over-applying nitrogen.", "Provide good air movement around plants through proper spacing, staking of plants and weed control.", "Once a week, examine five mature leaves for powdery mildew infection. In large plantings, repeat at 10 different locations in the field.", "If susceptible varieties are growing in an area where powdery mildew has resulted in yield loss in the past, fungicide may be necessary."]
    },
    "Strawberry___Leaf_scorch":{
        ...
        "Prevention": ["Since this fungal pathogen over winters on the fallen leaves of infect plants, proper garden sanitation is key.", "This includes the removal of infected garden debris from the strawberry patch, as well as the frequent establishment of new strawberry transplants.", "The avoidance of waterlogged soil and frequent garden cleanup will help to reduce the likelihood of spread of this fungus."]
    },
    ...
    "Tomato___Early_blight":{
        ...
        "Prevention": ["Use pathogen-free seed, or collect seed only from disease-free plants.", "Rotate out of tomatoes and related crops for at least two years.", "Control susceptible weeds such as black nightshade and hairy nightshade, and volunteer tomato plants throughout the rotation.", "Fertilize properly to maintain vigorous plant growth. Particularly, do not over-fertilize with potassium and maintain adequate levels of both nitrogen and phosphorus.", "Avoid working in plants when they are wet from rain, irrigation, or dew.", "Use drip irrigation instead of overhead irrigation to keep foliage dry."]
    },
    "Tomato___Late_blight":{
        ...
        "Prevention": ["Use drip irrigation and avoid watering foliage.", "Space plants to provide good air movement between rows and individual plants." ,"Stake, string or prune to increase airflow in and around the plant.", "Sterilize stakes, ties, trellises etc. with 10 percent household bleach or commercial sanitizer.", "Circulate air in greenhouses or tunnels with vents and fans and by rolling up high tunnel sides to reduce humidity around plants.", "Keep night temperatures in greenhouses higher than outside temperatures to avoid dew formation on the foliage.", "Remove crop residue at the end of the season. Burn it or bury it away from tomato production areas."]
    },
    "Tomato___Septoria_leaf_spot":{
        ...
        "Prevention": ["Remove diseased leaves.", "Improve air circulation around the plants.", "Mulch around the base of the plants", "Do not use overhead watering.", "Use fungicidal sprayes."]
    },
    "Tomato___Spider_mites Two-spotted_spider_mite":{
        ...
        "Prevention": ["Remove a few branches from the lower part of the plants to allow better airflow at the base", "Remove and burn the lower leaves as soon as the disease is seen, especially after the lower fruit trusses have been picked.", "Keep plots free from weeds, as some may be hosts of the fungus.", "Do not use overhead irrigation; otherwise, it will create conditions for spore production and infection."]
    },
    "Tomato___Tomato_Yellow_Leaf_Curl_Virus":{
        "Crop": "Tomato",
        "Disease": "Yellow Leaf Curl Virus",
        "Cause": ["TYLCV is transmitted by the insect vector Bemisia tabaci in a persistent-circulative nonpropagative manner. The virus can be efficiently transmitted during the adult stages.", "This virus transmission has a short acquisition access period of 15 to 20 minutes, and latent period of 8 to 24 hours."],
        "Prevention": ["Currently, the most effective treatments used to control the spread of TYLCV are insecticides and resistant crop varieties.", "The effectiveness of insecticides is not optimal in tropical areas due to whitefly resistance against the insecticides; therefore, insecticides should be alternated or mixed to provide the most effective treatment against virus transmission.", "Other methods to control the spread of TYLCV include planting resistant/tolerant lines, crop rotation, and breeding for resistance of TYLCV. As with many other plant viruses, one of the most promising methods to control TYLCV is the production of transgenic tomato plants resistant to TYLCV."]
    },
